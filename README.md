...
For **SRD**, the dataset contains **2,680 training pairs** and **408 testing pairs**. Each pair consists of a shadow image and its corresponding shadow-free image. Since the original SRD dataset does not provide official shadow masks, **we directly used the DHAN-provided predicted SRD masks** as fixed mask priors in our experiments.
